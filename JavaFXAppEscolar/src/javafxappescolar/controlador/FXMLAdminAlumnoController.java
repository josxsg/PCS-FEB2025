...
public class FXMLAdminAlumnoController implements Initializable, INotificacion {
    ...
    private void btnClicEliminar(ActionEvent event) {
        ...
        if (pos >= 0) {
            ...
            Utilidad.mostrarAlertaSimple(Alert.AlertType.WARNING, 
                    "Selecciona un alumno", "Para eliminar la información de un alumno debes seleccionarlo primero.");
        }
    }
    ...
    private void eliminarAlumno(int idAlumno) {
        try {
            ...
            Utilidad.mostrarAlertaSimple(Alert.AlertType.ERROR, "Error al eliminar", 
                    "Lo sentimos, por el momento no se puede realizar esta operación");
        }
    }
}
